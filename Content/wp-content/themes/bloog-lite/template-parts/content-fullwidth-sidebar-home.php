<?php
/**
 * The template used for displaying latest post in full width with sidebar in home page
 *
 * @package Bloog Lite
 */
...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
  ...
  <div class="entry-content">
    <?php
    $bloog_img_src = wp_get_attachment_image_src( get_post_thumbnail_id(), 'bloog-homeslider-image-size', false ); 
    ?>
    <div class="bloog_img_wrap">
      <a href="<?php the_permalink(); ?>"><img src="<?php echo $bloog_img_src[0]; ?>" /></a>
      <div class="bloog-cat-wrap">
    ...
    <div class="excerpt_post_content"><?php
     ...
     <a class="continue_link" href="<?php the_permalink(); ?>"><?php esc_html_e('Continue Reading','bloog-lite');?></a>
   </div><!-- .entry-content -->
