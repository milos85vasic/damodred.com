 ...
 */
class Elegant_Magazine_Dropdown_Taxonomies_Control extends WP_Customize_Control {
    ...
    public function render_content() {
        ...
        <label>
            ...
            <select <?php $this->link(); ?>>
                <?php
                printf( '<option value="%s" %s>%s</option>', 0, selected( $this->value(), '', false ), __( 'All', 'elegant-magazine' )  );
                ?>
 ...
 * @see WP_Customize_Control
 */
class Elegant_Magazine_Radio_Image_Control extends WP_Customize_Control {
 ...
 * @access public
 */
class Elegant_Magazine_Customize_Section_Upsell extends WP_Customize_Section {
