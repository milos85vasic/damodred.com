 ...
 * @since 1.0.0
 */
function elegant_magazine_ocdi_after_import() {
    ...
    $menu_location_details = array(
        'em-top-nav' => 'top-menu',
        'em-primary-nav'      => 'main-menu',
        'em-social-nav'      => 'social-menu',
        'em-footer-nav'      => 'footer-enu',
    );
...
add_action( 'pt-ocdi/after_import', 'elegant_magazine_ocdi_after_import' );